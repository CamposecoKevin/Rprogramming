...
##descargar una hoja de calculo queda pendiente, ver codigo,
...
dat<- xlsx::read_xlsx(file = "getdata%2Fdata%2FDATA.gov_NGAP.xlsx", sheetIndex = 1, rowIndex = 18:23, colIndex = 7:15)
...
url <-"http://www.ine.gob.gt/sistema/uploads/2014/02/24/xWtgQPXVhBV5BTBADdWNX7CIAZ5hMSuJ.xlsx"
setwd(file.path("D:/R/Rprogramming/DescargarArchivosconURL"))
local<- file.path("data", "DescargarArchivosconURL.data")
